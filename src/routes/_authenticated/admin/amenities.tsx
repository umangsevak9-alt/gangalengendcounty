    ...
    <div className="max-w-5xl mx-auto py-8 px-6">
      ...
      <div className="flex items-center justify-between gap-4 mb-8 flex-wrap">
        <div>
          ...
          <h1 className="text-3xl font-serif text-[#0a0a0a]">Amenities</h1>
    ...
    <div className="bg-white rounded-lg border border-[#e5e5e5] p-4 flex items-center gap-4">
      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-center gap-2">
          <h3 className="font-serif text-[#0a0a0a] truncate">{row.title}</h3>
          <span className="text-xs px-1.5 py-0.5 rounded bg-[#f0f0f0] text-[#525252]">#{row.sort_order}</span>
        </div>
        {row.note && <p className="text-sm text-[#525252] mt-1 line-clamp-2">{row.note}</p>}
      </div>
